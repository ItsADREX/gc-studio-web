          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 mt-5 px-4 py-2 rounded-2xl bg-brand-pink/30 border border-brand-pink text-brand-rose font-semibold text-sm hover:bg-brand-pink transition-colors"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-8">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-4 rounded-2xl font-semibold text-sm bg-brand-dark hover:bg-brand-rose text-white hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-brand-dark/20 transition-all"
                >
                  <MessageCircle className="w-4 h-4" />
